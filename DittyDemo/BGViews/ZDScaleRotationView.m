...
@interface ZDScaleRotationView ()

@end

@implementation ZDScaleRotationView
...
- (void)startAnimation {
    ...
    UIView *squareView = [[UIView alloc] initWithFrame:(CGRect){0, 0, size.width * 0.2, size.height * 0.2}];
    ...
    void(^ReverseAnimationBlock)() = ^void() {
        POPBasicAnimation *animation20 = [self scaleFromValue:[NSValue valueWithCGSize:(CGSize){1.5, 1.5}] toValue:[NSValue valueWithCGSize:(CGSize){3.0, 3.0}]];
    ...
    POPBasicAnimation *animation10 = [self scaleFromValue:[NSValue valueWithCGSize:(CGSize){0.2, 0.2}] toValue:[NSValue valueWithCGSize:(CGSize){1.5, 1.5}]];
